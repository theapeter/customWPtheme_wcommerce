<?php
/**
 * AlPacas functions and definitions
 *
 ...
 */
function alpacas_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on AlPacas, use a find and replace
		* to change 'alpacas' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'alpacas', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'alpacas' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'alpacas_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'alpacas_setup' );
 ...
 */
function alpacas_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'alpacas_content_width', 640 );
}
add_action( 'after_setup_theme', 'alpacas_content_width', 0 );
 ...
 */
function alpacas_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'alpacas' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'alpacas' ),
...
add_action( 'widgets_init', 'alpacas_widgets_init' );
